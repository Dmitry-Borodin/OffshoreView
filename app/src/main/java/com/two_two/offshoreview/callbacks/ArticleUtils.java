...
public class ArticleUtils {
    public static ArrayList<Article> loadListArticleOffshore(RequestQueue requestQueue){
        JSONObject response = Requestor.sendJsonRequest(requestQueue, "http://offshoreview.eu/api/get_recent_posts/?json=1&json_unescaped_unicode=1&count=15");
    ...
    public static ArrayList<Article> loadListArticleVenture(RequestQueue requestQueue){
        JSONObject response = Requestor.sendJsonRequest(requestQueue, "http://ventureview.eu/api/get_recent_posts/?json=1&json_unescaped_unicode=1&count=15");
        ArrayList<Article> listArticles = Parser.parseJSONResponse(response);
    ...
    public static ArrayList<Article> loadListArticleEmoney(RequestQueue requestQueue){
        JSONObject response = Requestor.sendJsonRequest(requestQueue, "http://emoneyview.eu/api/get_recent_posts/?json=1&json_unescaped_unicode=1&count=15");
        ArrayList<Article> listArticles = Parser.parseJSONResponse(response);
    ...
    public static ArrayList<Article> loadListArticleCatalog(RequestQueue requestQueue){
        JSONObject response = Requestor.sendJsonRequest(requestQueue, "http://catalog.offshoreview.eu/api/get_recent_posts/?json=1&json_unescaped_unicode=1&count=15");
        ArrayList<Article> listArticles = Parser.parseJSONResponse(response);
